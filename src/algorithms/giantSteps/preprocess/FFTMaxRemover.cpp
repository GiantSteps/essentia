...
const char* FFTMaxRemover::name = "FFTMaxRemover";
const char* FFTMaxRemover::description = DOC("Remove n First Max FFT");


void FFTMaxRemover::configure() {
...
const char* FFTMaxRemover::name = standard::FFTMaxRemover::name;
const char* FFTMaxRemover::description = standard::FFTMaxRemover::description;

FFTMaxRemover::FFTMaxRemover() : AlgorithmComposite() {

  _FFTMaxRemover = standard::AlgorithmFactory::create("FFTMaxRemover");
...
FFTMaxRemover::~FFTMaxRemover() {
  delete _FFTMaxRemover;
  delete _poolStorage;
}

void FFTMaxRemover::reset() {
  AlgorithmComposite::reset();
  _FFTMaxRemover->reset();
}

AlgorithmStatus FFTMaxRemover::process() {
  if (!shouldStop()) return PASS;

 
  //const vector<Real>& signal = _pool.value<vector<Real> >("internal.signal");

  _FFTMaxRemover->input("signal").set(_pool.value<vector<Real> >("internal.signal"));
  _FFTMaxRemover->output("Harmonic").set(_Harmonic);
  _FFTMaxRemover->output("Noise").set(_Noise);
  _FFTMaxRemover->compute();
