...
const char* barkOnset::name = "barkOnset";
const char* barkOnset::description = DOC("This algorithm extracts some Bark bands based spectral features from an audio signal");

barkOnset::barkOnset() : _configured(false) {
  // input:
...
void barkOnset::createInnerNetwork() {
